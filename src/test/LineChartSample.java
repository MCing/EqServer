...
public class LineChartSample extends Application {
    ...
    private void init(Stage primaryStage) {
        ...
        NumberAxis xAxis = new NumberAxis("Values for X-Axis", 0, 60, 1);
        ...
        ObservableList<XYChart.Series<Double,Double>> lineChartData = FXCollections.observableArrayList(
            new LineChart.Series<Double,Double>("Series 1", FXCollections.observableArrayList(
                ...
                new XYChart.Data<Double,Double>(10.0, 1.0),
                new XYChart.Data<Double,Double>(11.2, 1.4),
                new XYChart.Data<Double,Double>(12.2, 1.9),
                new XYChart.Data<Double,Double>(12.7, 2.3)
            )),
