...
public class LineChartSample extends Application {
    ...
    private void init(Stage primaryStage) {
        ...
        LineChart.Series<Double,Double> series1 = new LineChart.Series<Double,Double>("Series 1", FXCollections.observableArrayList(
        ...
        LineChart.Series<Double,Double> series2 =  new LineChart.Series<Double,Double>("Series 2", FXCollections.observableArrayList(
...
//        Node line = series1.lookup(".chart-series-line");
